...
INLA requires that latent random effect $\pmb{w}(\pmb{s})$ be a GMRF. We use the method of \cite{Lindgren2011}, who use an SPDE to explicitly link a Mat\'ern GRF to a GMRF. 
