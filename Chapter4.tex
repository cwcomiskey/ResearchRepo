...
In practical terms, this rate of increase translates to prohibitively slow model fitting. To attempt fitting SGLMMs in practically useful time spans, we try: 
