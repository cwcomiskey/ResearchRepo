...
Typically the closed form for the target distribution, the posterior of interst, is unavailable. However, it will be available up to a proportionality constant, which is easy to see in the familiar Bayes proportionality, for observation vector $\pmb{y}$ and parameter vector $\theta$ \citep{Banerjee2014}.
