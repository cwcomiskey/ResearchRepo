...
Now we use game theory and pitch location error to interpret aspects of a Peralta VR heat map. Figure 1.12 shows Peralta's VR heat map for stopping rule $n_{b} < 200$.
        \begin{figure}[H]
      	\centering      
